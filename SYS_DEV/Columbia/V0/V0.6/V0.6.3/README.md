# V 0.6.3
## Sensor node
1. Extended battery life through hardware and software changes.
2. Removed solar charging.
3. Removed jumpers.
4. Added SN74LVC8T245DGVR logic leveler.
5. Added powerdown logic to code when idle.
